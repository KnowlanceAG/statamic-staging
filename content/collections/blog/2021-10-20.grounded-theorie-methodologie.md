      ...
      -
        ...
        attrs:
          values:
            type: bild_und_text
            bild:
              - blog/2021/grounded-theorie/Konzeptualisierung-grounded-theorie-modell.png
            text: 'Laut Strauss und Corbin „jeder Satz und Absatz sollte aufgebrochen werden und zu jedem einzelnen Vorfall oder jede Idee, in der etwas ein Phänomen darstellt, einen Namen vergeben.“(Strauss und Corbin, 1990). Unter offenem Kodieren versteht man die Zerlegung der Informationen in kleinere Konzepte. Im Kodierungsprozess werden alle Informationen, die für die Forschungsfrage wichtig sein könnten, in größere Sinneinheiten kategorisiert (Kategorienbildung). Basierend auf den Schlüsselkategorien wird die Theorie gebildet.'
