    ...
    bard:
      ...
      -
        ...
        content:
          -
            type: text
            text: 'Heute mit dem Thema: Ghostwriter-Preise bei GWriters. Ich beantworte Euch heute also einmal die Frage "Was leisten wir eigentlich?" und "Was bekommt Ihr für Euer Geld?". Dafür schauen wir uns die folgenden vier Punkte an: GWriters selbst als akademische Ghostwriting-Agentur, dann den '
          -
            type: text
            marks:
              -
          ...
          -
            type: text
            text: ' an sich, weiterhin den Qualitätsmanager bei GWriters und weitere individuelle Faktoren, die natürlich den Ghostwriter Preis beeinflussen können.'
      -
        type: set
        attrs:
          values:
