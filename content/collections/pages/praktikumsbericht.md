                          ...
                          - type: text
                            marks:
                              - type: textColor
                                attrs:
                                  color: orange-700
                            text: "Welchen Nutzen hat das Praktikum für mein Studium/meinen Beruf gebracht?"
            show_as_card: false
        type: row
        enabled: true
        responsive_columns: 0
                      ...
                      - type: tableCell
                        ...
                        content:
                          - type: paragraph
                            ...
                            content:
                              - type: text
                                text: "• zusammenfassendes und wertendes\_Fazit zum Schluss formulieren"
                              - type: hardBreak
                              - type: text
              ...
              - type: set
                attrs:
                  ...
                  values:
                    ...
                    faq_tabs:
                      - id: lsyhnwrs
                        tab_headline: "Fragen & Antworten: Praktikumsbericht-Vorlage"
                        items:
                          - id: lsyhoheq
                            headline: "Wie hilfreich ist eine Praktikumsbericht-Vorlage?"
                            accordion_content:
                              - type: paragraph
                                content:
                                  - type: text
                            ...
                            active: true
                          - id: lsyhp3dx
                            headline: "Was beinhaltet eine Vorlage für einen Praktikumsbericht?"
                            accordion_content:
                              - type: paragraph
                                content:
                                  - type: text
                            ...
                            active: false
                          - id: lsyhpeke
                            headline: "Kann eine Vorlage für jede Art von Praktikum und für jeden Fachbereich angewendet werden?"
                            accordion_content:
                              - type: paragraph
                                content:
                                  - type: text
...
schema_objects: |-
  <script type="application/ld+json">
  {
    ...
    "mainEntity": [{
      "@type": "Question",
      "name": "Wie hilfreich ist eine Praktikumsbericht-Vorlage?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Sehr hilfreich. Auf diese Weise erstellen Sie schnell und sicher einen perfekten Praktikumsbericht, denn nur so können Sie einen Praktikumsbericht solide erstellen. Diese Vorlage gibt Ihnen nahezu „automatisch“ den Aufbau eines Praktikumsberichts vor. Kann für alle Arten von Praktikumsberichten und für alle Anwendungsbereiche verwendet und auf die persönlichen Bedürfnisse angepasst werden.

  Dies ist besonders dann relevant, wenn ein Praktikumsbericht als Voraussetzung für eine Hausarbeit, eine Seminararbeit, eine Bachelorarbeit oder eine Masterarbeit gesehen oder vom Lehrstuhl verlangt wird. Auch Diplomarbeiten oder sogar Dissertationen sehen häufig Praxisinhalte in Form eines Praktikumsberichtes vor. Auch im Rahmen von Präsentationen, die im Rahmen eines Studiums gehalten werden, spielen Praktikumsberichte häufig eine wichtige Rolle."
      }
    },{
      "@type": "Question",
      "name": "Was beinhaltet eine Vorlage für einen Praktikumsbericht?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Eine Vorlage für einen Praktikumsbericht beinhaltet das Inhaltsverzeichnis, die Einleitung, den Hauptteil und das Fazit mit den dazugehörigen Inhaltspunkten, die es zu füllen gilt. Letztere entfernen Sie im Rahmen der Erstellung der Arbeit. Sie sollen Ihnen nur als Anhaltspunkt dienen, was in den einzelnen Bereichen erwartet ist."
      }
    },{
      "@type": "Question",
      "name": "Kann eine Vorlage für jede Art von Praktikum und für jeden Fachbereich angewendet werden?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Ja, das kann sie. Sie müssen Sie nur auf ihren individuellen Kontext anpassen. Die Grundstruktur ist dabei aber für jeden Fachbereich und für jeden Einsatz gleich."
      }
